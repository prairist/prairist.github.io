    ...
    void (function(global, factory) {
      ...
      Han.fn = Han.prototype = {
        ...
        render: function(routine) {
          ...
          routine.forEach(function(method) {
            if (
   ...
   */
      ...
      var TYPESET = (function() {
        ...
        return {
          ...
          hws: {
            ...
            strict: [
              new RegExp(
                '(' + rHan + ')' + rWhite + '?(' + rAlph + '|' + rPtOpen + ')',
                'ig'
              ),
              new RegExp(
                '(' + rAlph + '|' + rPtEnd + ')' + rWhite + '?(' + rHan + ')',
                'ig'
              ),
            ],
          },
      ...
      var $ = {
        ...
        isIgnorable: function($node) {
          ...
          return (
            $node.nodeName === 'WBR' || $node.nodeType === Node.COMMENT_NODE
          );
        },
      ...
      var Fibre =
        ...
        (function(Finder) {
          ...
          function matches(node, selector, bypassNodeType39) {
            ...
            var matches =
              Efn.matches ||
              Efn.mozMatchesSelector ||
              Efn.msMatchesSelector ||
              Efn.webkitMatchesSelector;
          ...
          if (typeof document === 'undefined')
            throw new Error('Fibre requires a DOM-supported environment.');
          ...
          Fibre.fn = Fibre.prototype = {
            ...
            init: function(context, noPreset) {
              ...
              if (!context) {
                throw new Error(
                  'A context is required for Fibre to initialise.'
                );
            ...
            filterFn: function(node) {
              ...
              return this.preset === 'prose'
                ? AVOID_NON_PROSE(node) && result
                : result;
            },
            ...
            revert: function(level) {
              ...
              var level =
                Number(level) ||
                (level === 0 ? Number(0) : level === 'all' ? max : 1);
          ...
          (function() {
            ...
            Finder.prototype = {
                  ...
                  for (var i = 0, l = textAggregation.length; i < l; ++i) {
                    ...
                    if (regex.global) {
                      while ((match = regex.exec(text))) {
                        matches.push(
                          self.prepMatch(match, matchIndex++, offset)
                        );
                      }
                    } else {
              ...
              prepMatch: function(match, matchIndex, characterOffset) {
                ...
                match.endIndex =
                  characterOffset + match.index + match[0].length;
              ...
              processMatches: function() {
                ...
                out: while (true) {
                  if (curNode.nodeType === 3) {
                    if (
                      !endPortion &&
                      curNode.length + atIndex >= match.endIndex
                    ) {
                    ...
                    if (
                      !startPortion &&
                      curNode.length + atIndex > match.startIndex
                    ) {
                  ...
                  if (startPortion && endPortion) {
                    ...
                    atIndex -=
                      endPortion.node.data.length - endPortion.endIndexInNode;
                    startPortion = null;
                    endPortion = null;
                    innerPortions = [];
                    match = matches.shift();
              ...
              prepareReplacementString: function(
                string,
                portion,
                match,
                matchIndex
                ...
                if (matchStartNode === matchEndNode) {
                  ...
                  this.reverts.push(function() {
                    if (preceedingTextNode === newNode.previousSibling) {
                      preceedingTextNode.parentNode.removeChild(
                        preceedingTextNode
                      );
                    }
                    if (followingTextNode === newNode.nextSibling) {
                      followingTextNode.parentNode.removeChild(
                        followingTextNode
                      );
                    }
                  ...
                  for (var i = 0, l = innerPortions.length; i < l; ++i) {
                    ...
                    portion.node.parentNode.replaceChild(
                      innerNode,
                      portion.node
                    );
                    this.reverts.push(
                      (function(portion, innerNode) {
                        return function() {
                          innerNode.parentNode.replaceChild(
                            portion.node,
                            innerNode
                          );
                        };
                  ...
                  matchEndNode.parentNode.insertBefore(
                    followingTextNode,
                    matchEndNode
                  );
      ...
      function getFuncOrElmt(obj) {
        return typeof obj === 'function' || obj instanceof Element
          ? obj
          : undefined;
      }
      ...
      $.extend(Fibre.fn, {
        ...
        jinzify: function(selector) {
          return this.filter(selector || null)
            .avoid('h-jinze')
            .replace(TYPESET.jinze.touwei, function(portion, match) {
            ...
            .replace(TYPESET.jinze.wei, function(portion, match) {
              var elem = $.create('h-jinze', 'wei');
              elem.innerHTML = match[0];
              return portion.index === 0 ? elem : '';
            })
            .replace(TYPESET.jinze.tou, function(portion, match) {
            ...
            .replace(TYPESET.jinze.middle, function(portion, match) {
        ...
        groupify: function(option) {
          ...
          if (option.biaodian) {
            this.replace(TYPESET.group.biaodian[0], createBDGroup).replace(
        ...
        charify: function(option) {
          ...
          if (option.kana) {
            this.wrap(
              TYPESET.char.kana,
              getFuncOrElmt(option.kana) || $.clone($.create('h-char', 'kana'))
            );
          }
          if (option.eonmun || option.hangul) {
            this.wrap(
          ...
          for (var j = 1; j <= 20; j++) {
            for (var i = 1; i <= 50; i++) {
              if (
                ...
                a.getImageData(i, j, 1, 1).data[3] !==
                  b.getImageData(i, j, 1, 1).data[3]
              ) {
                ret = false;
                break;
      ...
      Locale.support = (function() {
        ...
        return {
          ...
          'ruby-display': (function() {
            ...
            div.innerHTML =
              '<h-test-a style="display: ruby;"></h-test-a><h-test-b style="display: ruby-text-container;"></h-test-b>';
            return (
              div.querySelector('h-test-a').style.display === 'ruby' &&
              div.querySelector('h-test-b').style.display ===
                'ruby-text-container'
            );
          })(),
          ...
          'ruby-interchar': (function() {
            ...
            div.innerHTML =
              '<h-test style="-moz-ruby-position:' +
              IC +
              ';-ms-ruby-position:' +
              IC +
            ...
            return (
              css.rubyPosition === IC ||
              css.WebkitRubyPosition === IC ||
              css.MozRubyPosition === IC ||
              css.msRubyPosition === IC
            );
          })(),
      ...
      function renderSimpleRuby($ruby) {
        ...
        $.tag('rt', frag.firstChild).forEach(function($rt) {
          var $rb = $.create('!');
          var airb = [];
          var irb;
      ...
      function renderComplexRuby($ruby) {
        ...
        void (function($rtc) {
          ...
          $ru = $.tag('rt', $rtc).map(function($rt, i) {
            if (!$rb[i]) return;
        ...
        $.qsa('rtc:not(.zhuyin)', $cloned).forEach(function($rtc, order) {
          var ret;
          ret = $.tag('rt', $rtc).map(function($rt, i) {
        ...
        renderRuby: function(context, target) {
          ...
          $target.forEach(function($ruby) {
            ...
            if (clazz.contains('complex')) $new = renderComplexRuby($ruby);
              ...
              $new = SUPPORT_IC
                ? renderInterCharRuby($ruby)
                : renderSimpleRuby($ruby);
      ...
      void ['Elem', 'DecoLine', 'Em', 'Ruby'].forEach(function(elem) {
      ...
      function real$hwsElmt(portion) {
        return portion.index === 0 ? $.clone($hws) : '';
      }
      ...
      $.extend(Han, {
        renderHWS: function(context, strict) {
          ...
          // HWS rendering mode.
          var AVOID = strict ? 'textarea, code, kbd, samp, pre' : 'textarea';
      ...
      $.extend(Han.fn, {
        ...
        revertHWS: function() {
          $.tag('h-hws', this.context).forEach(function(hws) {
            $.remove(hws);
          });
          this.HWS = [];
          return this;
      ...
      function detectSpaceFont() {
        ...
        div.innerHTML =
          '<span>a b</span><span style="font-family: \'Han Space\'">a b</span>';
      ...
      function insertHangableCS($jinze) {
        ...
        if ($cs && matches($cs, 'h-cs.jinze-outer')) {
          ...
          $jinze.insertAdjacentHTML('afterend', HANGABLE_CS_HTML);
        }
      }
      ...
      $.extend(Han, {
        ...
        renderHanging: function(context) {
          ...
          finder
            ...
            .replace(TYPESET.jinze.hanging, function(portion) {
              if (/^[\x20\t\r\n\f]+$/.test(portion.text)) {
                return '';
              }
      ...
      $.extend(Han.fn, {
        renderHanging: function() {
          ...
          if (Han.isSpaceFontLoaded && classList.contains('no-han-space')) {
      ...
      function trimBDClass(clazz) {
        return clazz
          .replace(/(biaodian|cjk|bd-jiya|bd-consecutive|bd-hangable)/gi, '')
          .trim();
      }
      ...
      $.extend(Han.fn, {
        ...
        revertJiya: function() {
          $.qsa('h-char.bd-jiya, h-cs.jiya-outer', this.context).forEach(
            function($elmt) {
              var classList = $elmt.classList;
      ...
      function createSubstFactory(regexToSubst) {
        return function(context) {
          ...
          regexToSubst.forEach(function(pattern) {
            finder.replace(new RegExp(pattern[0], 'ig'), function(
              portion,
              match
            ) {
      ...
      $.extend(Han, {
        ...
        substVowelCombLiga: createSubstFactory(
          Han.TYPESET['display-as']['comb-liga-vowel']
        ),
        substZhuyinCombLiga: createSubstFactory(
          Han.TYPESET['display-as']['comb-liga-zhuyin']
        ),
        substCombLigaWithPUA: createSubstFactory(
          Han.TYPESET['display-as']['comb-liga-pua']
        ),
        ...
        substInaccurateChar: function(context) {
          ...
          Han.TYPESET['inaccurate-char'].forEach(function(pattern) {
            finder.replace(new RegExp(pattern[0], 'ig'), pattern[1]);
          });
        },
      });
